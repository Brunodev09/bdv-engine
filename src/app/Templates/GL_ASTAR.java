...
public class GL_ASTAR extends ScriptGL {
    ...
    final SpriteSheet green = new SpriteSheet("spritesheet2", new Rectangle(256, 256), 1, 0);
    final SpriteSheet black = new SpriteSheet("spritesheet2", new Rectangle(256, 256), 2, 1);
    final SpriteSheet white = new SpriteSheet("spritesheet2", new Rectangle(256, 256), 0, 1);
